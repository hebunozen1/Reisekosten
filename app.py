...
# Große Handyfotos sollen nicht zu einem 500-Fehler führen.
# Bei Bedarf kann der Wert in Render über MAX_UPLOAD_MB angepasst werden.
app.config["MAX_CONTENT_LENGTH"] = int(os.environ.get("MAX_UPLOAD_MB", "20")) * 1024 * 1024


@app.errorhandler(RequestEntityTooLarge)
def handle_file_too_large(error):
    flash("Die hochgeladene Datei ist zu groß. Bitte ein kleineres Bild hochladen oder MAX_UPLOAD_MB in Render erhöhen.", "err")
