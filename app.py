...
@app.route("/admin/belege-upload")
def belege_upload_page():
    """Separate restore page so templates/admin.html stays stable."""
    if session.get("role") != "buchhaltung":
        return redirect(url_for("login"))
    return render_template("belege_upload.html")
