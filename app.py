...
def restore_belege():
    ...
    allowed_extensions = {".jpg", ".jpeg", ".png", ".webp", ".gif", ".pdf", ".heic", ".heif"}

    def target_relative_name(zip_member_name):
        """Return the filename/path that should be restored under uploads/.

        Supports both backup formats:
        1. app backup: uploads/<filename>
        2. browser emergency backup: belege_backup/<filename> or files at ZIP root
        """
        ...
        if name.startswith("uploads/"):
            ...
            # Browser-ZIP kann Dateien auch direkt im Hauptordner enthalten.
    ...
    try:
        ...
        with zipfile.ZipFile(tmp_upload_path, "r", allowZip64=True) as zipf:
            ...
            for member in zipf.infolist():
                rel_name = target_relative_name(member.filename)
